...
class BaseListViewController: UIViewController {
    ...
    enum ItemID: Hashable {
        case film(ListViewController.ImageCell.Configuration.ID)
        case emtpy
    }
    
    struct VM {
        var films: [ListViewController.ImageCell.Configuration]
    }
    ...
    private func configureDiffableDataSource() {
        let cellRegistration = UICollectionView.CellRegistration<UICollectionViewCell, ListViewController.ImageCell.Configuration> { (cell, indexPath, itemIdentifier) in
            cell.contentConfiguration = itemIdentifier
        }
        let emptyCellRegistration = UICollectionView.CellRegistration<UICollectionViewCell, ListViewController.EmptyCell.Configuration> { (cell, indexPath, itemIdentifier) in
            cell.contentConfiguration = itemIdentifier
        }
        ...
        diffableDataSource = UICollectionViewDiffableDataSource<Section, ItemID>(collectionView: collectionView) { (collectionView, indexPath, itemIdentifier) -> UICollectionViewCell? in
            ...
            case .emtpy:
                return collectionView.dequeueConfiguredReusableCell(using: emptyCellRegistration, for: indexPath, item: ListViewController.EmptyCell.Configuration())
            }
        }
